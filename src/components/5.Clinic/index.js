...
function Services() {
  return (
    <div className="container clinic" id="consultorio">
      <section className={styles.sectionAbout}>
        <div className="d-flex justify-content-between align-items-center mb-5 services-card flex-wrap">
          
          <div className="col-lg-7 col-md-12 services animate-on-visible">
            <div className="about-services animate-on-visible">
          ...
          <div className="col-lg-5 col-md-12 services animate-on-visible">
            <div className={styles.content}>
              <img src={consultorio} alt="Dr. Pedro Siqueira" className="icon-service" />
            </div>
          </div>
